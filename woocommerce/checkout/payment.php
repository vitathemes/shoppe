...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<?php endif; ?>
	<div class="woocommerce-checkout-submit-wrapper">
		<noscript>
			<?php
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="c-btn c-btn--primary c-btn--lg button alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '">' . esc_html( $order_button_text ) . '</button>' ); // @codingStandardsIgnoreLine ?>
