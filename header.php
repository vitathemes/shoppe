...
?>
<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'shelly' ); ?></a>
            ...
            <div class="o-grid-middle">
                <div class="o-col-6_md-3">
                    <div class="c-header__branding s-header-branding">
						<?php do_action( 'shelly_branding_hook' ); ?>
                    </div>
                </div>
                <div class="o-col-6_md-9">
                    <div class="c-header__nav js-header-nav">
						<?php do_action( 'shelly_header_hook' ); ?>
                    </div>
                </div>
            </div>
        </div>
...
<div class="o-popup js-popup">
    <button aria-label="<?php esc_attr_e('Close popup', 'shelly'); ?>" class="o-popup__close js-popup-close">
